...
task generate_tracks{
    ...
    command <<<
        ...
        bedtools genomecov -g ~{chromosome_sizes_file} -ibam ~{output_prefix}_fwd.bam -bg -scale $scale_factor > ~{output_prefix}_cpm_fwd.bedgraph
        ...
        # run bedtools genomecov
        bedtools genomecov -g ~{chromosome_sizes_file} -ibam ~{output_prefix}_rev.bam -bg -scale $scale_factor_rev > ~{output_prefix}_cpm_rev.bedgraph
        ...
        #  RNA bigwig
        bedtools genomecov -g ~{chromosome_sizes_file} -ibam ~{bam} -bg -scale $scale_factor > ~{output_prefix}_cpm.bedgraph
